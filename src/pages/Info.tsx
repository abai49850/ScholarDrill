...
const docs: Record<string, Doc> = {
  about: {
    title: "About ScholarDrill",
    subtitle: "Australia's smartest test preparation platform.",
    sections: [
      { heading: "Our mission", body: "We believe every Australian student deserves access to world-class, affordable test preparation. ScholarDrill combines AI-generated, curriculum-aligned questions with adaptive difficulty so students can practise smarter — not just harder." },
      ...
      { heading: "Built in Australia", body: "ScholarDrill is designed and built in Australia by a small team of educators and engineers, with content aligned to the Australian Curriculum (v9) and ACARA standards." },
    ],
  },
  blog: {
    title: "ScholarDrill Blog",
    subtitle: "Tips, study guides and updates from the ScholarDrill team.",
    sections: [
  ...
  careers: {
    title: "Careers at ScholarDrill",
    subtitle: "Help us shape the future of education in Australia.",
    sections: [
      { heading: "Why ScholarDrill", body: "We're a small, focused team building tools that meaningfully improve outcomes for Australian students. We work remotely across Australia with quarterly in-person meetups." },
  ...
  contact: {
    title: "Contact ScholarDrill",
    subtitle: "We'd love to hear from you.",
    sections: [
      { heading: "Support", body: "For help with your account, billing, or technical issues, email support@scholardrill.com.au and we'll get back to you within one business day." },
      { heading: "Schools & partnerships", body: "Interested in bringing ScholarDrill to your school or tutoring group? Email partnerships@scholardrill.com.au." },
      { heading: "Press & media", body: "For press enquiries, contact press@scholardrill.com.au." },
    ],
  },
  privacy: {
    ...
    sections: [
      { heading: "Overview", body: "ScholarDrill respects your privacy. This policy explains what information we collect, how we use it, and the choices you have. We comply with the Australian Privacy Principles under the Privacy Act 1988 (Cth)." },
      ...
      { heading: "Your rights", body: "You can request access to or deletion of your personal data at any time by emailing privacy@scholardrill.com.au." },
    ],
  },
  terms: {
    ...
    updated: "Last updated: May 2026",
    sections: [
      { heading: "Acceptance", body: "By creating an account or using ScholarDrill, you agree to these Terms of Service. If you are under 18, a parent or guardian must agree on your behalf." },
      ...
      { heading: "Acceptable use", body: "Use ScholarDrill for personal study only. Don't attempt to scrape questions, reverse engineer the service, or use it to harass other users." },
      ...
      { heading: "Disclaimer", body: "ScholarDrill is a study tool. We don't guarantee any particular exam outcome. Always cross-check critical information with official exam authorities." },
    ],
  },
  refund: {
    title: "Refund Policy",
    ...
    sections: [
      ...
      { heading: "How to request a refund", body: "Email billing@scholardrill.com.au with your account email and the reason for your request. We aim to respond within two business days." },
