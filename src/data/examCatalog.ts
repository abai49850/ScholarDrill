...
export const examCards: ExamCard[] = [
  {
    ...
    yearLevels: [3, 5, 7, 9],
    icon: "N",
    sourceLabel: "ACARA NAPLAN public demonstration",
    sourceUrl: "https://www.nap.edu.au/naplan/public-demonstration-site",
    sections: [
  ...
  },
  {
    ...
    yearLevels: [5, 6],
    icon: "NSW",
    sourceLabel: "NSW selective practice tests",
    sourceUrl: "https://education.nsw.gov.au/schooling/parents-and-carers/choosing-a-school-setting/selective-high-schools/placement-test/selective-high-school-practice-tests.html",
    sections: [
  ...
  },
  {
    ...
    icon: "EDU",
    sourceLabel: "EduTest practice test information",
    sourceUrl: "https://www.edutest.com.au/prac_tests.html",
    sections: [
